  ...
  [
    ...
    },
    {
      ...
      body: [
        ...
        'Dark Mandala created by The Philosopher to summon demons and undeads. I am a Brazilian Philosophy Professor, Traditional and NFT Artist, Virtual Curator and Gallerist. I was part of many solo and collective physical exhibitions in Rio de Janeiro (BELA Biennial, Fabrica Bhering, Meu BB Galeria), Ouro Preto (GLTA), Brasília (Federal Senate), Macapá (Galeria Trokkal) and Helsinque (AVA Galleria/BELA Biennial). As a curator and gallerist, I made many virtual exhibitions for some communities, like VIBES community, Mintbase community, CriptoArteBR community. As an artist, I work with collage, assemblage, painting, bronze sculpture and digital art. I am also an ambassador from CryptoHamsters NFT-Project, owner from Brazucas NFT Gallery, and owner from multiple wearables stores and a gallery on Cryptovoxels called "The Philosopher\'s Gallery". I am represented by the traditional AVA Galleria (from Finland) and the virtual gallery Binaria.',
