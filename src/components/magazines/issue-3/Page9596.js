...
const Page9596 = () => {
  return (
    <div className={styles.wrapper}>
      <img src="/magazine/3/images/95_96/image1.png" className={styles.image1}/>
