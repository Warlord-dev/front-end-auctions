  ...
  return (
    <div className={styles.wrapper}>
      ...
      <Link href="https://www.instagram.com/shiu_studio/ ">
        <a target="_blank">
        <img src="/magazine/3/images/95_96/image3.png" className={styles.image4}/>
        </a>
      </Link>
      
      <p className={styles.text6}>Shiu Studios</p>   
      <img src="/magazine/3/images/95_96/image7.png" className={styles.image8}/>
      <img src="/magazine/3/images/95_96/image5.png" className={styles.image6}/>
      <img src="/magazine/3/images/95_96/image4.png" className={styles.image5}/>
      <p className={styles.text7}>Avatar created by Zbrush</p>   
      <img src="/magazine/3/images/95_96/image6.png" className={styles.image7}/>
      <img src="/magazine/3/images/95_96/image8.png" className={styles.image9}/>
