...
const Page4142 = () => {
  return (
    <div className={styles.wrapper}>
      ...
      <p className={styles.text10}>RULER PROTOCOL</p>  
      ...
      <img src="/magazine/3/images/39_40/image13.png" className={styles.image26}/> 
      <img src="/magazine/3/images/39_40/image17.png" className={styles.image32}/>  
      <img src="/magazine/3/images/39_40/image22.png" className={styles.image34}/> 
