...
const Page8384 = () => {
  return (
    <div className={styles.wrapper}>
      <img src="/magazine/3/images/83_84/image1.png" className={styles.image1}/>
      ...
      <p className={styles.text5}>WEAR TO DEFI x FRACTIONAL GARMENT ONWERSHIP DRIP HOODIES and caps. nft fashion with stakeable crypto yield.</p>
      <p className={styles.text6}>WEB3 Wiazrds COLLECTiBLES.</p>
      <img src="/magazine/3/images/83_84/image2.png" className={styles.image4}/>
      <img src="/magazine/3/images/83_84/image3.png" className={styles.image5}/>
      <img src="/magazine/3/images/83_84/image4.png" className={styles.image6}/>
      ...
      <img src="/magazine/3/images/83_84/image8.png" className={styles.image10}/>
      <img src="/magazine/3/images/83_84/image9.png" className={styles.image11}/>
