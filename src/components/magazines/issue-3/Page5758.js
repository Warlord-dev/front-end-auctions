...
const Page5758 = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <p className={styles.text3}>Most of us remember the craziness of DeFi Summer mid 2020, where we all sat in awe watching the Total Value Locked (TVL) across DeFi protocols exponentially skyrocket from tens of millions to tens of billions in just a few short months. It was an incredibly significant moment for the entirety of the crypto community, where effective usage of blockchain and web3 took a new turn for the better in actually directly being beneficial to a broader retail market, beyond just speculation and hype of new token launches or fancy tech savvy protocols with implementation scheduled for “sometime in the next 2-5 years”. 
<br/><br/>
