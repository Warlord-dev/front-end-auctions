...
<span className={styles.text20}>With Layer 2s and side chains being all the rave, have you ever wondered what the flow of activity and token transfers really is between Ethereum mainnet and these </span></p>
...
<br/><br/>
They also currently have discord integration compatibility— highly relevant for a lot of DAOs building their communities today. </span></p>
      <p className={styles.text28}>NFTags<br/>
<span className={styles.text29}>After the NFT rush earlier this year many of us became acquainted with NFTs as natively digital assets that only exist online. However, their application potential expands far wider, </span></p>
      <p className={styles.text30}>and in fact has some of the most promise when it comes to the intersection between the digital and physical— where NFTs are able to streamline and transparently reconcile the ledger of goods between these two realms. This afterall is a large component of materialising the metaverse. 
      <br/><br/>
