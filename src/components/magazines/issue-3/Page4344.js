...
const Page4344 = () => {
  ...
  return (
    <div className={styles.wrapper}>
      <img src="/magazine/3/images/43_44/image2.png" className={styles.image1}/>
      <img src="/magazine/3/images/43_44/image1.png" className={styles.image2}/>
      ...
      <div className={styles.image12}>
        <div className={styles.image13}>
          <video ref={ref2} className={styles.image14} muted autoPlay loop>
            <source src="./magazine/3/images/43_44/video2.mp4" type="video/mp4" />
          </video>
        </div>
        <button onClick={()=>{playVideo2()}}><img src={`./magazine/3/images/43_44/${isPlaying2 ? 'pause' : 'play'}.png`} className={styles.playbutton2}/></button>
      </div>
      ...
      <img src="/magazine/3/images/43_44/image8.png" className={styles.image8}/>
      ...
      <div className={styles.image9}>
        ...
        <button onClick={()=>{playVideo1()}}><img src={`./magazine/3/images/43_44/${isPlaying1 ? 'pause' : 'play'}.png`} className={styles.playbutton1}/></button>
      </div>
