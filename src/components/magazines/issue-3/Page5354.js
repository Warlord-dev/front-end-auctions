...
<br/><br/>
There’s no question that massive amounts of capital are flowing into numerous DeFi protocols—but the industry remains volatile as ever. Much of the activity has been centered on yield generation, speculation, and leverage. Moreover, the programmability, immutability, and interoperability that DeFi services offer also have their share of new and untested risks.
<br/><br/>
...
We’re past the point of hype. The quantum leaps and bounds we see in finance as driven by crypto are but a little taste of what’s possible as far as money’s function is concerned. Yes, the DeFi space is fledgling, with plenty of lost time to make up against legacy financial services and technology. But the possibility of how radically finance can be transformed when anyone with a modicum of coding knowledge can freely participate in building their own solution in the coming years is a future so tantalizing it’s worth paying to see.</p>  
      ...
      <br/><br/>
Today I am very excited about Non-Fungible Tokens and how they can literally carry my traits around as a kind of rich information like DNA, where at any time I can organize a collection and make these gems available for other digital hunters. I'm feeling so ready for this!"</p>   
...
Captain America's pink shield is a really special item as it was the key for me into starting to make 3D. This was my first object made in Blender. So many great memories!</p>
      <p className={styles.text5}>OMEGA<br/>
The texture, appearance and colors were accidentally replaced. Glad that the final render turned out ok and I am very happy to have it now as an NFT. It deserves this on-chain immutability!</p>
      <p className={styles.text6}>ALPHA<br/>
This token is a portal that was just waiting to turn into an NFT. Now your powers have increased.<br/></p>
    </div>
  );
};
