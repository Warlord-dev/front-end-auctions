...
const Page3940 = () => {
  return (
    <div className={styles.wrapper}>
      ...
      <p className={styles.text9}>MAKERDAO</p>  
      ...
      <p className={styles.text17}>Using fashion to onboard millions into DeFi by directly serving their desires.</p>  
      <img src="/magazine/3/images/39_40/image27.png" className={styles.image32}/>  
      <img src="/magazine/3/images/39_40/image12.png" className={styles.image33}/>  
      <img src="/magazine/3/images/39_40/image24.png" className={styles.image34}/> 
      <img src="/magazine/3/images/39_40/image23.png" className={styles.image35}/> 
      <img src="/magazine/3/images/39_40/image15.png" className={styles.image36}/>  
    </div>
  );
};
