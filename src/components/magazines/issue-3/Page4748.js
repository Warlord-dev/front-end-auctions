...
After her graduate studies, Anna worked three years in an architectural firm before setting off on a global nomadic pursuit from India to Thailand, Bali, Spain, Italy, and Bulgaria. Travelling the world by herself she finally settled in San Francisco, California. She is currently designing immersive Art life experiences and hosting open studio events across different venues throughout the Bay Area. </p> 
      ...
      <img src="/magazine/3/images/47_48/image7.png" className={styles.image17}/>
      <p className={styles.text8}>To describe HAPI it will be better to lean back on the importance of cyber security in general. The current scourge that is plaguing digital currency market is insecure and unsafe environment embroiled in nefarious projects trying to fraud their investors. The same can be also accentuated in regards to vulnerabilities of CEXes to hacking attacks and intrusions. Irrespective of whether you follow crypto market religiously or not, you probably heard about the abundance of hacks that has taken place in the last year.  At HAPI we see it as the most egregious omission that has been rampant for some time now. In order to rectify it, we decided to converge one of the leading cyber sec experts together and create a project that TRULY serves the purpose. This is what HAPI stands for - cyber security thereby we call ourselves cyber security protocol. Hacken Foundation has given us a needed push and procured us with everything that is needed in order to realize this endeavor including the much needed cyber security audit database. As of now we are fully independent and rely on our own vision of the project and its future development.</p> 
      <p className={styles.text9}>HAPI was formed as a reaction to the rampancy of fraudulence and unsafe entourage of crypto in general. HAPI was created and engendered by the White Hat hacker who did win the Hacken-held Hackathon by hacking into the Hackathon's website and proclaiming himself a victor. Then the team was formed and the details about including the unexpectedly emergent project on the Hacken launchpad were settled. This is the short story of how the HAPI project has appeared.</p> 
      <p className={styles.text10}>The mission of HAPI is to rectify a cornucopia of issues that are entrenched in the current DeFi space. The approach HAPI takes does differ from the current solutions on the market. The differentiating points are both visible from the technical standpoint and community side of things. From the technical standpoint, HAPI incorporates a slew of preventative solutions that will inhibit exploits from transpiring beforehand. That also involves the utilization of the cybersecurity audit database by virtue of which malfeasance and maliciousness can be impeded in a timely manner. It is better illustrated in the following example: A particular DeFi is about to be a subject of a malicious exploitative attack. To aid in preventing the above-mentioned invasion, HAPI utilizes the combination of smart contract integration (SC) and Oraclization (oracles that are used on-chain). Before the attack has even been engendered, HAPI, with the help of off-chain dataprovider, can detect, mark, and delineate the potential threat of a particular address, by incorporating oracles specifically engineered, or programmed if you will, to preemptively act on the danger that a particular address poses. In this vein, a nascent calamity can be eluded against the clock. DAO will allow anyone to submit a maliciously active wallet address into the protocol wherein making the self-sustaining database that also rewards people for submitting these.</p> 
      <p className={styles.text11}>In short, web3 can also be called decentralization since the core idea of web3 is ushering in the peer-to-peer ungoverned ecosystem that is fully censor-resistant. Unlike web2 though that is centralized, regulated, and unbound in decreeing any restrictions, web3 enables the integrity of privacy to remain intact. The immediate problem that emerges from that however is that web3 is much more vulnerable to cyber security focused attacks, exploitations, and social engineering. This coupled with unrestrained and unpunishable nature of web3 gives rise to unbridled activity of villainous actors. Therefore in order to propel web3 to become viable, there is a need for the similar layer of security on web3 that operates within and by the conditions of decentralization. HAPI doesn't impinge on the grounds of decentralization by implementing centralized structures. Instead, HAPI leverages openness of Blockchain and transactions inside it to ensure safety of the end users.</p> 
