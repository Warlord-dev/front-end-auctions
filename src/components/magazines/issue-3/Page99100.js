...
const Page99100 = () => {
  return (
    <div className={styles.wrapper}>
       <img src="/magazine/3/images/99_100/image1.png" className={styles.image1}/>
      ...
      <img src="/magazine/3/images/99_100/image5.png" className={styles.image8}/>
      ...
      <img src="/magazine/3/images/99_100/image13.png" className={styles.image19}/>
      ...
      <img src="/magazine/3/images/99_100/image14.png" className={styles.image22}/>
      <div className={styles.image25}>
        <video className={styles.image26} muted loop autoPlay>
          <source src="./magazine/3/images/99_100/video4.mp4" type="video/mp4" />
        </video>
      </div>
