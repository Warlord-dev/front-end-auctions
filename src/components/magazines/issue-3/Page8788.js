...
const Page8788 = () => {
    ...
    return (
      <div className={styles.wrapper}>
        <img src="/magazine/3/images/87_88/image1.png" className={styles.image1}/>
      <img src="/magazine/3/images/87_88/image2.png" className={styles.image2}/>
      <img src="/magazine/3/images/87_88/image3.png" className={styles.image3}/>
      <img src="/magazine/3/images/87_88/image4.png" className={styles.image4}/>
      <img src="/magazine/3/images/87_88/image5.png" className={styles.image5}/>
      <img src="/magazine/3/images/87_88/image6.png" className={styles.image6}/>
      <img src="/magazine/3/images/87_88/image7.png" className={styles.image7}/>
      ...
      <p className={styles.text9}>parallel to doing what they love and know, then their prospects for more customised opportunities that suit each of them best only expands.</p>
