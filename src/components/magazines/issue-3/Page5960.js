...
const Page5960 = () => {
  ...
  return (
    <div className={styles.wrapper}>
      <img src="/magazine/3/images/59_60/image1.png" className={styles.image1}/>
      <Link href="https://digifizzy.xyz/unlockable/3">
        <a target="_blank">
        <img src="/magazine/3/images/59_60/image2.png" className={styles.image2}/>
        </a>
      </Link>
      
      <img src="/magazine/3/images/59_60/image3.png" className={styles.image3}/>
      <img src="/magazine/3/images/59_60/image4.png" className={styles.image4}/>
      <img src="/magazine/3/images/59_60/image5.png" className={styles.image5}/>
      <img src="/magazine/3/images/59_60/image6.png" className={styles.image6}/>
      <img src="/magazine/3/images/59_60/image7.png" className={styles.image8}/>
      <Link href="https://digifizzy.xyz/unlockable/3">
        <a target="_blank">
        <img src="/magazine/3/images/59_60/image2.png" className={styles.image11}/>
        </a>
      </Link>
      
      <div className={styles.image7}>
        <video className={styles.image10} muted loop autoPlay>
          <source src="./magazine/3/images/59_60/video1.mp4" type="video/mp4" />
        </video>
      </div>
      <img src="/magazine/3/images/59_60/image8.gif" className={styles.image9}/>
      <button onClick={() => {
          if (!play) {
          ...
          setPlay(!play);
        }}><img src={`./magazine/3/images/59_60/${play ? 'pause' : 'play'}.png`} className={styles.playbutton1}/></button>
...
<span className={styles.text3}> In web2 it’s entirely altruistic, you are depending on a one way incentive where the giver feels good for an obscure reason enough so to give to you. It’s a shot in the dark, and there is no clear path from 0 to 1, no clear solution to the cold start problem. In the web3 model, mutual incentives are aligned, where the creator can actually implement sustainability without excessive and unnecessary blocking points like paywalls and ad based models. It allows them to spin up personalised decentralised channels and invite people behind the scenes for exclusive content, unlockable drops and experience based backstage passes.  </span></p>  
      ...
      <audio
        ...
        src="./magazine/3/images/59_60/audio1.mp3"
      ></audio>
      ...
      <img src="/magazine/3/images/59_60/image9.png" className={styles.image13}/>
      ...
      <div className={styles.image14}>
        <video className={styles.image15} muted loop autoPlay>
          <source src="./magazine/3/images/59_60/video2.mp4" type="video/mp4" />
        </video>
      </div>
      <div className={styles.image16}>
        <video className={styles.image17} muted loop autoPlay>
          <source src="./magazine/3/images/59_60/video3.mp4" type="video/mp4" />
        </video>
      </div>
