  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.text2}>
        ...
        <br /><br />
        If price is prohibitive for you, I'd probably start on an L2 like polygon and that allows you to start collecting or and it's very affordable and that allows you to start buying into the space. And if it’s about creating some history, I would actually start off chain, but start creating your community around you. And that's something on Twitter or a Clubhouse or Telegram or Discord, or any of these platforms that all of us use and share your opinion or ask a question or reach out to someone that you admire for a conversation.
        <br /><br />
