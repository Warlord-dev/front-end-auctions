...
const Page7576 = () => {
  return (
    <div className={styles.wrapper}>
      <img src='/magazine/5/images/7576_image1.png' className={styles.image1} />
      <img src='/magazine/5/images/7576_image2.png' className={styles.image2} />
      <img src='/magazine/5/images/7576_image4.png' className={styles.image8} />
      <img src='/magazine/5/images/7576_image3.png' className={styles.image3} />
      <img src='/magazine/5/images/7576_image3.png' className={styles.image4} />
      <img src='/magazine/5/images/7576_image3.png' className={styles.image5} />
      <img src='/magazine/5/images/7576_image3.png' className={styles.image6} />
      <img src='/magazine/5/images/7576_image3.png' className={styles.image7} />

      <div className={styles.text1}>
        AND dismissing the strong likelihood of global cyber warfare, if not outright hotwar is an abnigation of responsibilities in the protection of         
      </div>
      <div className={styles.text2}>
        national security interests. Fundamentally, these regulators that are so anti-decentralisation are the amongst the worst contributors to the weakening of security postures for the prepartion against modern warfare. 
      </div>
      <div className={styles.text3}>
        The hardening of economic systems is one of the most underlooked and undervalued traits that emerges from live markets at the forefront of defi protocols, NFTs, and other decentralised tech. 
        <br /><br />
        If these stagnant minds continue to stand in the way of innovation and progress then what hope do we have. If we are waiting for the “it’s already too late” moment and the black swan event that ends up funnelling everything into being crypto and blockchain rooted we have a bigger problem on our hands than many of us are likely to believe.
        <br /><br /><br />
      ...
      <img src='/magazine/5/images/7576_image5.png' className={styles.image12} />

      <img src='/magazine/5/images/7576_image8.png' className={styles.image11} />
      <img src='/magazine/5/images/7576_image7.png' className={styles.image10} />
      ...
      <a href='http://cryptoyuna.art/' target='_blank'>
