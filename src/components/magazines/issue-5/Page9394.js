...
const Page9394 = () => {
  ...
  return (
    <div className={styles.wrapper}>
      <img src='/magazine/5/images/9394_image2.png' className={styles.image2} />
      ...
      <img src='/magazine/5/images/9394_image3.png' className={styles.image3} />

      <div className={styles.text7}>
        LOOK: A Fashion Derivative of Loot Project
      </div>
