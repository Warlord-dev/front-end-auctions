...
const Page99100 = () => {
  return (
    <div className={styles.wrapper}>
       ...
       <img src="./magazine/1/99_100/image5.png" className={styles.image5} />
       <img src="./magazine/1/99_100/image6.png" className={styles.image6} />
       <img src="./magazine/1/99_100/image7.png" className={styles.image7} />
       <img src="./magazine/1/99_100/image8.png" className={styles.image8} />
       <img src="./magazine/1/99_100/image9.png" className={styles.image9} />
       <img src="./magazine/1/99_100/image10.png" className={styles.image10} />
