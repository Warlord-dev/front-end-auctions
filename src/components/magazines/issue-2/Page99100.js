...
const Page99100 = () => {
  return (
    <div className={styles.wrapper}>
      ...
      <img async src="./magazine/2/images/99_100/leftImg1.png" className={styles.left1} />
      <img async src="./magazine/2/images/99_100/leftImg2.png" className={styles.left2} />
      <img async src="./magazine/2/images/99_100/leftImg3.png" className={styles.left3} />
      <img async src="./magazine/2/images/99_100/rightImg1.png" className={styles.right1} />
      <img async src="./magazine/2/images/99_100/rightImg2.png" className={styles.right2} />
      <video className={styles.right3} muted loop autoPlay>
        <source async src="./magazine/2/images/99_100/video1.mp4" type="video/mp4" />
       </video>
      <img async src="./magazine/2/images/99_100/rightImg4.png" className={styles.right4} />
