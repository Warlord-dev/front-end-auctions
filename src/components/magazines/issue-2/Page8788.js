...
const Page8788 = () => {
  ...
  const playVideo3 = () => {
    ...
    return (
      ...
      <img async src="./magazine/2/images/87_88/image1.png" className={styles.image1} />
      <img async src="./magazine/2/images/87_88/image2.png" className={styles.image2} />
      <img async src="./magazine/2/images/87_88/image3.png" className={styles.image3} />
      <img async src="./magazine/2/images/87_88/image4.png" className={styles.image4} />
      <img async src="./magazine/2/images/87_88/image5.png" className={styles.image5} />
      <img async src="./magazine/2/images/87_88/image7.gif" className={styles.image6} />
      <img async src="./magazine/2/images/87_88/image8.png" className={styles.image6} />
      <div className={styles.image7}>
        <div className={styles.image9}>
        <video ref={ref1} className={styles.image8} muted autoPlay loop>
          <source async src="./magazine/2/images/87_88/video1.mp4" type="video/mp4" />
        </video>
        </div>
      ...
      <div className={styles.image10}>
        ...
        <video ref={ref2} className={styles.image12} muted autoPlay loop>
          <source async src="./magazine/2/images/87_88/video2.mp4" type="video/mp4" />
        </video>
        </div>
      ...
      <div className={styles.image18}>
        <video ref={ref3} className={styles.image19} muted autoPlay loop>
          <source async src="./magazine/2/images/87_88/video3.mp4" type="video/mp4" />
        </video>
        </div>
