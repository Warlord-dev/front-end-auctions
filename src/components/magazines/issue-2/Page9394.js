...
const Page9394 = () => {
  return (
    <div className={styles.wrapper}>
      <img async src="./magazine/2/images/93_94/page87-left.png" className={styles.leftBack} />
      <img async src="./magazine/2/images/93_94/page87-right.png" className={styles.rightBack} />
      <img async src="./magazine/2/images/93_94/page87-right2.png" className={styles.rightBack} />
      <img async src="./magazine/2/images/93_94/page87-right3.png" className={styles.rightBottom} />
