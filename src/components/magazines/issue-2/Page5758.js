...
const Page5758 = () => {
  return (
    <div className={styles.wrapper}>
      <img src="./magazine/1/57_58/image1.png" className={styles.image1} />
      <Link href="https://dxdao.eth.link/"><a>
        <img src="./magazine/1/57_58/image2.png" className={styles.image2} />
        </a>
       </Link>
      <img src="./magazine/1/57_58/image3.gif" className={styles.image3} />
      <img src="./magazine/1/57_58/image4.png" className={styles.image4} />
      <img src="./magazine/1/57_58/image5.png" className={styles.image5} />
      <img src="./magazine/1/57_58/image6.png" className={styles.image6} />
      <img src="./magazine/1/57_58/image7.png" className={styles.image7} />
      <img src="./magazine/1/57_58/image8.png" className={styles.image8} />
      <img src="./magazine/1/57_58/image9.png" className={styles.image9} />
      <Link href="https://swapr.eth.link/#/swap"><a>
        <img src="./magazine/1/57_58/image10.png" className={styles.image10} />
        </a>
       </Link>
       <Link href="https://dxdao.eth.link/#/"><a>
        <img src="./magazine/1/57_58/image10.png" className={styles.image11} />
        </a>
       </Link>
       <Link href="https://omen.eth.link/#/liquidity"><a>
        <img src="./magazine/1/57_58/image10.png" className={styles.image12} />
        </a>
       </Link>
       <Link href="https://discord.gg/4QXEJQkvHH"><a>
        <img src="./magazine/1/57_58/image11.png" className={styles.image13} />
        </a>
       </Link>
       <Link href="https://discord.gg/4QXEJQkvHH"><a>
        <img src="./magazine/1/57_58/image11.png" className={styles.image14} />
        </a>
       </Link>
       <Link href="https://discord.gg/4QXEJQkvHH"><a>
        <img src="./magazine/1/57_58/image11.png" className={styles.image15} />
        </a>
       </Link>
       <Link href="https://twitter.com/SwaprEth"><a>
        <img src="./magazine/1/57_58/image12.png" className={styles.image16} />
        </a>
       </Link>
       <Link href="https://twitter.com/DXdao_"><a>
        <img src="./magazine/1/57_58/image12.png" className={styles.image17} />
        </a>
       </Link>
       <Link href="https://twitter.com/Omen_eth"><a>
        <img src="./magazine/1/57_58/image12.png" className={styles.image18} />
        </a>
       </Link>
       <Link href="https://dxdao.medium.com/"><a>
        <img src="./magazine/1/57_58/image13.png" className={styles.image19} />
        </a>
       </Link>
       <Link href="hhttps://daotalk.org/c/dx-dao/15"><a>
        <img src="./magazine/1/57_58/image14.png" className={styles.image20} />
        </a>
       </Link>
       <img src="./magazine/1/57_58/image15.png" className={styles.image21} />
       <Link href="https://daostack.io/"><a>
        <img src="./magazine/1/57_58/image16.png" className={styles.image22} />
        </a>
       </Link>
       <Link href="https://aragon.org/"><a>
        <img src="./magazine/1/57_58/image17.png" className={styles.image23} />
        </a>
       </Link>
       <Link href="https://snapshot.org/#/"><a>
       <img src="./magazine/1/57_58/image18.png" className={styles.image24} />
       </a>
       </Link>
      ...
      <p className={styles.text3}>SOVEREIGNTY. ON-CHAIN. </p>
