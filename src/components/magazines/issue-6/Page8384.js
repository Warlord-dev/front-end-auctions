  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.text2}>
        {' '}
        What gave the Loot community so much strength and growth velocity almost instantly? Is there
        some magic trick that other communities can emulate?
      </div>
      <div className={styles.text3}>
        Everything moves so fast in crypto, how do you keep community momentum and engagement
        rising, which Loot was a perfect example of?
      </div>
      <div className={styles.text4}>
        The community of builders in the Loot ecosystem is tight-knit and working to create a strong
        foundation. If there are new derivatives and other projects launching, that will be a rising
        tide that lifts all boats in the community (builders and the broader Loot community
        together).
      </div>
      <div className={styles.text5}>
        Why did you decide $AGLD? Does the come from a deep childhood experience with RPGs and
        gaming or was it something else?
      </div>
      <div className={styles.text6}>
        I thought it was an interesting experiment to add an in-game currency to future Loot games.
        I used to run a game server many years ago, and I thought that a token with a fair launch to
        unify the community would be important.
      </div>
      <div className={styles.text7}>
        How important is composability for a meta community? Like what we see with Loot, there is
        one big community, but then subsets of mini DAOs and builders everywhere.
      </div>
      <div className={styles.text8}>
        Extremely important and the key to Loot's success. Without on-chain data and composability,
        we wouldn't see the depth of derivatives that we have.
      </div>
      <div className={styles.text9}>
        Where does syndicate DAO fit with all of this? How important do you think it is for the
        tools for community building in web3 to evolve?
      </div>
      <div className={styles.text10}>
        Syndicate DAO helps investing DAOs launch with best-in-class tokenomics and governance. We
        care deeply about building strong communities, and Loot is one of the examples of organic
        communities that can emerge in web3. Governance and tokenomics are still so early and we
        spend a lot of time at Syndicate developing best practices for the projects that we work
        with.
      </div>
      <div className={styles.text11}>
        Where are the essential tools to build communities in web3? Where does anyone wanting to
        grow a community authentically start?
      </div>
      <div className={styles.text12}>
        The most important factor is alignment on a community's goals. Usually these communities
        spin out of group chats, Discord servers, or existing projects. Having a group of people who
        are aligned from the start is extremely important.
      </div>
      <div className={styles.text13}>
        You seem uniquely positioned to give insight on the tension between traditional VC investor
        money and direct to market web3 native sales and funding. How do these tensions get
        resolved?
      </div>
      <div className={styles.text14}>
        I see it as similar to top-down vs bottom-up initiatives. VC is a fantastic way to fund a
        project on a multi-year timeline, if you know your strategy upfront. Direct to market web3
        sales are a great way to experiment and learn as you go. There is a role for both in the
        ecosystem. Syndicate is working on a timeline of many years, and VC allows us to think on a
      ...
      <div className={[styles.embed, 'twitter-embed'].join(' ')}>
        <blockquote className="twitter-tweet">
          <p lang="en" dir="ltr">
            ...
            , and how to create thriving NFT communities is online!
            <a href="https://t.co/N6n9Pkm9vJ">https://t.co/N6n9Pkm9vJ</a>
            <br />
            <br />
            The key lessons are:
            <br />
            1. Less is more.
            <br />
            2. Think carefully about tokenomics upfront.
            <br />
            3. On-chain composability is the future of NFTs.
            <br />
            <br />
            🧵 Thread below:
          </p>
          &mdash; Will Papper ✺ (@WillPapper){' '}
          <a href="https://twitter.com/WillPapper/status/1445561531320598533?ref_src=twsrc%5Etfw">
            October 6, 2021
          </a>
        </blockquote>
      </div>
      ...
      <div className={styles.link1Text}>Will Papper</div>
      <a href="https://twitter.com/thattallguy" target="_blank">
        <img src="/magazine/6/images/83_84_image2.png" className={styles.link2} />
      </a>
      <div className={styles.link2Text}>Jess</div>
      <a href="https://seedclub.xyz/" target="_blank">
        <img src="/magazine/6/images/83_84_image3.png" className={styles.link3} />
      </a>
      <div className={styles.text15}>Social tokens for Community & More.</div>
      ...
      <img src="/magazine/6/images/83_84_gif.gif" className={styles.gif} />
    </div>
  );
};
