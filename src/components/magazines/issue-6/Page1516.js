  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.text7}>
        I do have a lot of pretty strong thoughts on good practices and bad practices for DAOs. I do believe that there are already some that are kind of coming into the space implementing practices that are maybe not the best way to do things. So as far as token gating content, or token gating sections of a community, I think that I stand on both sides of the fence somewhere in the middle of a good integration of both, where you do token gate certain aspects to encourage quality work, getting stuff done without disruption, but also, really being careful not to gate off too much of your community so as to not become more elitist. So I think some communities have, basically, maybe not even on purpose, have stood on this elitist mentality where to get into our discord, to get into our content or to get into our incentives, you must buy this much and own this much per month or whatever. And I think a lot of these types of incentive structures will kind of fade away. Those who push more for either sweat equity, or quality content, I think is really more the better practice. I think we're moving away from this, just like how a YouTuber, content creator is moving more away from chasing what the mainstream media says is the content everyone wants is the stuff I should do. Rather, the stuff I'm going to do is my passion, my skill, my experience, and I will provide the best, the highest quality content that I can, according to my skill set, according to my character and applying that to the world and not chasing the dollar. So really trying to affect the individual getting the content or whatever the product might be in a positive manner, rather than just trying to extract value out of another human.
        <br /><br />
        So yeah, it's really fun and interesting to watch the organic growth that comes from projects like Metaverse Music Festival, and I love being a part of that type of stuff, even in real life, when seeking out communities or homesteads to go, help build infrastructure, I seek out people who are just implementing their vision, who are just starting their farm or whatever. So I love to see organic growth and see visions come to a reality and help be a part of supporting that. But I think a really good example of community that's a little bit further in their development, and are regularly daily, hourly, by the minute struggling with making this actual coordination work well, and trying to make services products, platforms that just make this type of coordination easier, and make everyone more successful, that's Metagame. Metagame, they're really working hard to not only change the world, but to bridge that gap from where we are now, to where we all want to already be, we'd rather just be building the new world, but we realize that there is this bridge, there's all these bridges that need to be built for everyone to be able to walk across from the old system to the new system, you can't just flip a switch, we really have to build these tools, these mechanisms, these systems, for people to plug into and be able to leave the system that's already set up and created with the rules in place.
        <br /><br />
        We are at the beginning of a massive explosion of new platforms, new products, new networks, new metaverses and I think later on down the road, much later on down the road, it will be a mixed platform, a multiverse, multi platform, multi chain type of thing that we deal with, but not necessarily one to rule them all for each sector. And so kind of like when we talk about realms, there are certain aspects to different realms that I like more than others. And yet, I don't discount certain realms because they have their own use case. I love CryptoVoxels but I can't display certain materials there. I love Somnium Space for the realistic type of items that I can put in that area. But I don't like the movement as much. So I like Decentraland in the cartoony style that they have going and the movement. I like how game like it is. But, I don't like their governance. So there are different aspects that I think different people will like and not like. They may completely discount some realms altogether and hate them. Or they may have a list of realms that are their favorites and they use multiples. So I think that's kind of where we are going to be; the same for tokens, for networks, for different NFT platforms as well.
        <br /><br />
        My advice for new people coming into this space is to always take your time, because this space is exploding. There's always so many projects going on that it can really keep you moving too fast from one thing to the next, that you never really deep dive deep into each thing. So I would encourage people to do things like read the boring white paper, they're not that bad, we try to make them pretty cool now. That's really important to understand the use case of whatever platform or token or community you might be entering into, or, whether you even want to be a part of that. And I'd say the other big thing is, don't be afraid to get into the discords. Get into the telegrams. I don't personally like telegram, but get into the community chat rooms, because that's where all the action is. That's where all the alpha is. Join their community calls, don't be afraid to speak up when they ask. And there's no question too dumb, too small, too stupid, whatever. I don't believe in that. There's no way for any of us to learn anything without asking questions, most of us are pretty kind and cool.
      </div>
      <div className={styles.text8}>
        Musashi’s journey into web3 community, among other things. 
      </div>
    </div>
  )
}
