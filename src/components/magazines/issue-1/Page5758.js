  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.leftText}>
        ...
        <br />
        His love with colors, shapes, and movement. He is a Domestika's teacher and, along with his
        wife, works in their design studio, Veleta Studiolab, where they collaborate with clients on
        projects to explore different approaches to aesthetics and communication.
        <br />
        <br />
        The Walkers is a 3 part project. Domingo was inspired by the way feelings can move from one
      ...
      <div className={styles.rightSecondText}>
        ...
        <br />
        <br />
        Stow is the creator of a form of post-expressionism called “motionism”. He is an
        award-winning film-maker, writer, actor, and director appearing in major motion pictures,
        on-stage, indie projects, and music videos.
      </div>
    </div>
  );
};
