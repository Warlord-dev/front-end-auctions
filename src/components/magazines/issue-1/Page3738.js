...
const Page3738 = () => {
  return (
    <div className={styles.wrapper}>
      ...
      <h1>
        The Long Thread of Textile History Continues
      </h1>
      <h2>
        India Embraces Digital Fashion
      </h2>
      ...
      <div className={styles.circleText2}>
        The sherwani; a long coat-like jacket that is knee length and originated in 19th century India.<br /><br />
        The jacket contains lotus flowers, which symbolize purity, enlightenment and self-regeneration— a popular symbol in India and around the world.
      </div>
      ...
      <div className={styles.circleText3}>
        A popular form of Indian women’s dress, the Lehenga Choli, 
        which originated in North India during the 10th century and is often worn for weddings or other formal events. <br /><br />
        The pattern on the skirt is a binary flower, fusing the traditional – a flower – with the futuristic – 0’s and 1’s used in binary codes popularized in the movie the Matrix. 
        The blouse contains a cubed pattern containing my initials, RGS, and was sketched by hand by Nureen Wohl, a social worker based in New York City. 
        The headscarf, or the dupatta, contains an intricate piece of forehead jewelry, called a maang tikka.
      </div>
    </div>
  )
}
