  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.text}>
        ...
        It’s for anyone out there that truly believes in the potentiality of where we are headed.
        It’s for those that want to be part of building the right metaverse, underwriting it with
        the value and ethos that we keep being promised, but is yet to actually play out.
        <br />
        <br />
        We are all climbing a mountain that has never been climbed before. There is no textbook or
        pre-prepared answers for what is to come as we traverse these new plains. But ultimately,
        there doesn’t need to be. Because we all already know the map that we want to navigate. It’s
        one that ensures openness, vitality and allows us the ability to spin up personal
        decentralised realms with dynamic access keys.
        <br />
        <br />
        ...
        <br />
        <br />
        DIGIFIZZY is for the gatemakers.
        <br />
        <br />
