...
const Page5152 = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image1} />
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image2} />
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image3} />
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image4} />
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image5} />
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image6} />
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image7} />
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image8} />
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image9} />
      <img src='./magazine/4/images/5152_instagram.png' className={styles.image10} />

      <img src='./magazine/4/images/5152_background1.png' className={styles.background1} />
      <img src='./magazine/4/images/5152_zero.png' className={styles.image11} />
      <img src='./magazine/4/images/5152_zero.png' className={styles.image12} />
      <img src='./magazine/4/images/5152_zero.png' className={styles.image13} />
      <img src='./magazine/4/images/5152_zero.png' className={styles.image14} />
      <img src='./magazine/4/images/5152_zero.png' className={styles.image15} />
