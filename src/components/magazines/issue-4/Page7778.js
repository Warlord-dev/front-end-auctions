...
const Page7778 = () => {
  return (
    <div className={styles.wrapper}>
      <img className={styles.image1} src='/magazine/4/images/7778_background.png' />
      <img className={styles.image2} src='/magazine/4/images/7778_iamge1.png' />
      ...
      <div className={styles.text4}>
        BURN YOUR ERC-721 TO UNLOCK A COLLECTION OF ERC-1155 NFTs + HIDDEN MAGAZINE CONTENT AND DYNAMIC NFT AIRDROPS. 3 x BUNDLES: COMMON, SEMI-RARE, EXCLUSIVE.         
      </div>
