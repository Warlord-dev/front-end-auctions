...
const Page4546 = () => {  
  return (
    <div className={styles.wrapper}>
      <img className={styles.image1} src='/magazine/4/images/4546_image1.png' />
      <img className={styles.image2} src='/magazine/4/images/4546_image2.png' />
      <img className={styles.image3} src='/magazine/4/images/4546_image3.png' />
      ...
      <img className={styles.image7} src='/magazine/4/images/4546_image4.png' />
      <img className={styles.image8} src='/magazine/4/images/4546_image5.png' />

      <img className={styles.rect1} src='/magazine/4/images/4546_image6.png' />
      <img className={styles.rect2} src='/magazine/4/images/4546_image6.png' />
      <img className={styles.rect3} src='/magazine/4/images/4546_image6.png' />
      <img className={styles.rect4} src='/magazine/4/images/4546_image6.png' />
