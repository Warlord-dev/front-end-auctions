...
const Page117118 = () => {
  return (
    <div className={styles.wrapper}>
      <img src='/magazine/4/images/8182_image21.png' className={styles.image1} />
      ...
      <img src='/magazine/4/images/117118_image1.png' className={styles.image7} />
      <img src='/magazine/4/images/117118_image1.png' className={styles.image8} />
      <img src='/magazine/4/images/117118_image1.png' className={styles.image9} />
      <img src='/magazine/4/images/117118_image1.png' className={styles.image10} />
      <img src='/magazine/4/images/117118_image1.png' className={styles.image11} />
      <img src='/magazine/4/images/117118_image1.png' className={styles.image12} />

      <div className={styles.rect1}></div>
      <div className={styles.rect2}></div>

      <div className={styles.textPatternWrapper2}>
        <div className={styles.textPattern}>
          3D Bookshelf Project
        </div>
        <div className={styles.textPattern}>
      ...
      <img src='/magazine/4/images/117118_image2.png' className={styles.image13} />
