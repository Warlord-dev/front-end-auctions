...
const Page113114 = () => {
  return (
    <div className={styles.wrapper}>
       <img src="/magazine/3/images/113_114/image1.png" className={styles.image1}/>
       <p className={styles.text1}>THAKANE</p>  
       <p className={styles.text2}>THAKANE</p>  
       <p className={styles.text3}>THAKANE</p>  
       <p className={styles.text4}>TAKAII</p>  
       <p className={styles.text5}>TAKAII</p>  
       <p className={styles.text6}>TAKAII</p>  
...
I was always sketching and drawing designs since I was a child, however my learn frugality meant that I would remix old clothes before trying to impress in mass trends. I apply that way of thinking very much in my activewear business, TAKAII. 
</p>  
      ...
      <img src="/magazine/3/images/113_114/image2.png" className={styles.image5}/>
...
This was really rewarding as again I used my connecting skills to bring more value and integrity to an otherwise pretty wasteful corporate culture.
      ...
      <img src="/magazine/3/images/113_114/image5.png" className={styles.image15}/>
...
A Ready-to-wear activewear collection will be inspired by this conceptual collection, and available for purchase as real life garments and/or digital twin, made-to-measure through a network of seamstresses on the TAKAII.com website. We will be using image scanning software from PS.Collective on our online shop, meaning you can preview a 3D activewear render, upload pictures of yourself, then we can derive your measurements and create our activewear made to measure just for you!
      ...
      <img src="/magazine/3/images/113_114/image8.png" className={styles.image22}/>
    </div>
  );
};
