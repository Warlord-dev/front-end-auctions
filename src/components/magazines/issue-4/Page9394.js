...
const Page9394 = () => {
  return (
    <div className={styles.wrapper}>
      ...
      <div className={[styles.textBack1, styles.musicFont, styles.blueColor].join(' ')}>
        <div>
          Rhythm to the verse
        </div>
        <div>
      ...
      <div className={[styles.textBack2, styles.musicFont, styles.blueColor].join(' ')}>
        <div>
          Rhythm to the verse
        </div>
        <div>
      ...
      <img className={styles.image5} src='./magazine/4/images/9394_image4.png' />
      <img className={styles.image6} src='./magazine/4/images/9394_image5.png' />
      
      <img className={styles.image7} src='./magazine/4/images/99100_image3.png' />
      <img className={styles.image8} src='./magazine/4/images/99100_image3.png' />
