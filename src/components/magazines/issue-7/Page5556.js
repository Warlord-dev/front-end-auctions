  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.text1}>
        ...
        Development. I always envisioned I would be part of something big and I thought making games
        ...
        it inside a game where everyone enjoys it, gives me a different kind of excitement. I myself
      ...
      <div className={styles.text3}>
        I love Blender because it's open source and you can go beyond! My favorite
      ...
      <div className={styles.text4}>
        At first, NFTs was a vague concept to me but I was already amazed by crypto currency in
      ...
      <div className={styles.text5}>
        ...
        absolutely loved and I really enjoyed. For all I thought my dream was finally moving
        forward then Covid 19 came along and the company didn’t have enough power to sustain us
        ...
        opportunities when I saw Sandbox. Fortunately, they had an opening post as a freelance
      ...
      <div className={styles.text6}>
        In Sandbox we do a variety of assets with certain themes which are often exciting; such as
      ...
      <div className={styles.text7}>
        ...
        and the opportunities that they have opened for us would never be available if it weren’t
        ...
        although. I believe in the future that it holds for everyone. Decentralization made us 
        realize how free we can be with our finances, and that truly benefits everyone.
        I think we are still early in these stages but it has been looking very good from this point.
        I think the metaverse will soon be our new reality as time goes by and it can be both good 
        and bad. It’s bad if it leads us away from real connection, but at the same time, all signs
        are showing that it's only going to catalyse our relationships further. 
      </div>
      <div className={styles.text8}>
        ...
        people like us special. It shows us our worth as artists and it has brought everyone
        confidence in their art. Even memes are welcome! I think the community has been really
        generous about NFTs and I hope it can continue on and fix every artist’s sense of self
        worth. For Web3 I think it mostly values you as a person where you aren’t seen as a product
        anymore, giving you more privacy and control over your own assets.
        <br />
        <br />
        To all the artists out there, I know how it can be scary to try a new path for our creative
        journey and sometimes we only want to try the things that other people already have paved, 
        however I think the universe has a way of creating new paths for us that may result to either 
        good or bad, but if we keep going through the same path over and over again, how do we experience
        change and growth? If people are not seeing value in your works it means that your place
        belongs somewhere else, it could be the metaverse. Alongside this, I would always recommend doing
        your own research before jumping on anything.
        <br />
        <br />
        Lots of creative stuff is coming for the next few months. Of course, the most exciting part is
        still being part of The Sandbox, we saw how other games grew and The Sandbox already has
        built a community that has opened up doors for other communities as well. I’ve also been working
        on 2 NFT collections on the side, which is VoxaMech and PixaSouls. VoxaMech is a voxel art
