...
const Page77 = () => {
  return (
    <div className={styles.wrapper}>
      <img className={styles.image1} src='/magazine/4/images/8384_image2_mobile.png' />
      <img className={styles.image2} src='/magazine/4/images/8384_image3.png' />
      <img className={styles.image3} src='/magazine/4/images/8384_image4.png' />
