...
const Page54 = () => {
  return (
    <div className={styles.wrapper}>
        <img src="/magazine/3/images/59_60/image11.png" className={styles.image1}/>
       <img src="/magazine/3/images/59_60/image12.png" className={styles.image2}/>
      ...
      <img src="/magazine/3/images/59_60/image12.png" className={styles.image20}/>
      <img src="/magazine/3/images/59_60/image11.png" className={styles.image21}/>
      <p className={styles.text12}>DECO <br/>ONLY FANS</p> 
      <p className={styles.text13}>DECO <br/>ONLY FANS</p> 
      <img src="/magazine/3/images/59_60/image2.png" className={styles.image22}/>
    </div>
  )
}
