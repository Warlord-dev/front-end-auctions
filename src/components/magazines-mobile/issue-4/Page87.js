...
const Page87 = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <img className={styles.image1} src='/magazine/4/images/9596_image3.png' />
      ...
      <img className={styles.image2} src='/magazine/4/images/9596_image5.gif' />
      <img className={styles.image3} src='/magazine/4/images/9596_image5.gif' />
      <img className={styles.image4} src='/magazine/4/images/9596_image5.gif' />
