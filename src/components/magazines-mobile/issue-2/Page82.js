  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.image7}>
        ...
        <button onClick={()=>{playVideo1()}} className={styles.playbutton}><img src={`./magazine/2/images/87_88/${isPlaying1 ? 'pause' : 'play'}.png`} /></button>
      </div>
      ...
      <div className={styles.image10}>
        ...
        <button onClick={()=>{playVideo2()}} className={styles.playbutton}><img src={`./magazine/2/images/87_88/${isPlaying2 ? 'pause' : 'play'}.png`} /></button>
      </div>
