...
const Page28 = () => {
  return (
    <div className={styles.wrapper}>
      <img src='./magazine/1/images/mobile/moshed2.png' className={styles.backImage} />
      <div className={styles.innerWrapper}>
      <h1>
      ROADMAP TO POS - ETHEREUM AND THE ENVIRONMENT
      </h1>
      <p className={styles.alignRight}>At this point many of us have heard of Proof Of Stake— although some may not understand yet how it works or why it matters so much. The importance isn’t so much that economic resources and game theory are used to secure the system, but more the fact that it requires skin in the game. Because if nothing is at risk then nothing has value.</p>
