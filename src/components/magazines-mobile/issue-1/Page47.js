...
const Page47 = () => {
  return (
    <div className={styles.wrapper}>
      ...
      <br /><br />
      Her advice; anyone can start in 3D.  “There are numerous tutorials available online, basically for free which will teach you fundamentals of 3D graphics. The rest is only limited to your imagination and creativity.”
      <br /><br />
      Through 3D, Sasmitha discovered the NFT space, where she minted here genesis NFT on NFTshowroom, built on the HIVE blockchain. She also just launched on Foundation! 
      </p>
