...
const Page42 = () => {
  return (
    <div className={styles.wrapper}>
       <img src="/magazine/3/images/47_48/image12.png" className={styles.image6}/>
      <img src="/magazine/3/images/47_48/image9.png" className={styles.image3}/>
      <p className={styles.text3}>Anya Chilli</p>
      <img src="/magazine/3/images/47_48/image4.png" className={styles.image4}/>
      <img src="/magazine/3/images/47_48/image10.png" className={styles.image2}/>
      ...
      <img src="/magazine/3/images/47_48/image11.png" className={styles.image1}/>
