        ...
        <div className="flex flex-col w-full bg-black">
          ...
          <div className="flex justify-between items-center mt-12">
            ...
            <p className="font-inter font-bold text-5xl text-gray-50 mt-16 text-center underline">
              <a className="mr-16 underline text-white" href="https://digitalax.xyz/fgo">FGO-0001</a>
              <span>|</span>
              <a className="ml-16 underline text-white" href="https://digitalax.xyz/fgo-2">FGO-0001_2</a>
            </p>
          </div>
        </div>
      </div >
