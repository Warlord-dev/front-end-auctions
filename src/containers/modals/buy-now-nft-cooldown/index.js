...
import { closeBuynowNftCoolDownModal } from '@actions/modals.actions';
import styles from './styles.module.scss';

const BuyNowNftCooldown = ({ className, title, buttonText1 }) => {
  const dispatch = useDispatch();

  const handleClose = () => {
    dispatch(closeBuynowNftCoolDownModal());
  };
...
BuyNowNftCooldown.defaultProps = {
  className: '',
  title: 'SLOW MODE ENABLED! ',
  buttonText1: 'ACCEPT THE QUEST',
};

export default BuyNowNftCooldown;
