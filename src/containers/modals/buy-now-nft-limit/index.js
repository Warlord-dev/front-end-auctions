...
import { closeBuynowNftLimitModal } from '@actions/modals.actions';
import styles from './styles.module.scss';

const BuyNowNftLimit = ({ className, title, buttonText1 }) => {
  const dispatch = useDispatch();

  const handleClose = () => {
    dispatch(closeBuynowNftLimitModal());
  };
