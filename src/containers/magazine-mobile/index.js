...
import Page89 from '@components/magazines-mobile/issue-1/Page89';
import Page91 from '@components/magazines-mobile/issue-1/Page91';
import Page92 from '@components/magazines-mobile/issue-1/Page92';
import Page90 from '@components/magazines-mobile/issue-1/Page90';
import Page93 from '@components/magazines-mobile/issue-1/Page93';
import Page94 from '@components/magazines-mobile/issue-1/Page94';
import Page95 from '@components/magazines-mobile/issue-1/Page95';
import Page96 from '@components/magazines-mobile/issue-1/Page96';
import Page97 from '@components/magazines-mobile/issue-1/Page97';
import Page98 from '@components/magazines-mobile/issue-1/Page98';

const MagazineViewer = (props) => {
  const { issueId, pageNumber, children, onSwitchViewer } = props;
  return (
    <>
      ...
      <ViewerSwitch viewers={['webview', 'mapview']} onSwitchViewer={onSwitchViewer} />
    </>
  );
};
